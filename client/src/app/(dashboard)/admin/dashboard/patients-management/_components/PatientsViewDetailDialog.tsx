    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="min-w-5xl max-h-[90vh] flex flex-col p-0">
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-6">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 p-6 bg-linear-to-br from-accent/60 to-secondary dark:from-accent dark:to-secondary rounded-lg mb-6">
