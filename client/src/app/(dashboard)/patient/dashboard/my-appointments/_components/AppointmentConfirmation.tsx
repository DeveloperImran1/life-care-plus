...
} from "@/app/(dashboard)/patient/dashboard/my-appointments/_services";
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {doctor.doctorSpecialties.map((ds, idx) => (
                      <span
                        key={idx}
                        className="px-2 py-1 bg-accent/50 text-primary text-xs rounded-md border border-primary/20"
                      >
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="bg-linear-to-br from-accent/60 to-secondary border border-primary/20 rounded-lg p-6 space-y-4">
              <div>
