...
const StepCard = ({ icon: Icon, title, description, index }: { icon: React.ElementType, title: string, description: string, index: number }) => {
    const bgColors = [
        'bg-accent/50', 'bg-pink-50', 'bg-green-50', 'bg-yellow-50',
        'bg-pink-50', 'bg-accent/50', 'bg-yellow-50', 'bg-green-50'
    ];
    const textColors = [
        'text-primary', 'text-pink-500', 'text-green-500', 'text-yellow-500',
        'text-pink-500', 'text-primary', 'text-yellow-500', 'text-green-500'
    ];
