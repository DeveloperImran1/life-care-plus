...
import { changeAppointmentStatus } from "@/features/patient/services/appointment.service";
        ...
        <div className="space-y-6 lg:col-span-1">
          ...
          {appointment.schedule && (
            <Card>
              ...
              <CardContent>
                <div className="bg-linear-to-br from-accent/60 to-secondary border border-primary/20 rounded-lg p-4 space-y-3">
                  <div>
