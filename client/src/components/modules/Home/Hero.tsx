  ...
  return (
    <div className="w-full relative">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(125% 125% at 50% 90%, #fff 28%, oklch(0.93 0.05 165) 62%, var(--primary) 100%)",
        }}
      />
      {/* Content Container */}
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                {buttons.primary && (
                  <Button
                    ...
                    className="h-[63.622px] gap-3 rounded-xl bg-primary px-8 text-[15.3px] text-primary-foreground hover:bg-primary/90"
                  >
                ...
                {buttons.secondary && (
                  <Button
                    ...
                    variant="outline"
                    className="h-[63.622px] gap-3 rounded-xl border-primary px-8 text-[15.3px] text-primary hover:bg-accent"
                  >
            ...
            <div className="flex items-center justify-center lg:justify-end">
              <div className="w-full max-w-[559.929px] rounded-2xl bg-white p-8 shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)]">
                ...
                <form className="space-y-6">
                  ...
                  <Button
                    type="submit"
                    className="h-[59.986px] w-full rounded-xl bg-primary text-[15.3px] text-primary-foreground hover:bg-primary/90"
                  >
                    {formCard.submitText}
                  </Button>
                </form>
